...
PVs = [{'no':1, 'bus':'56', 'numphase':3, 'phaseconn':'.1.2.3', 'size':200, 'kV':4.16, 'KVA':200},
       {'no':2, 'bus':'79', 'numphase':3, 'phaseconn':'.1.2.3', 'size':210, 'kV':4.16, 'KVA':210},
       {'no':3, 'bus':'82', 'numphase':3, 'phaseconn':'.1.2.3', 'size':220, 'kV':4.16, 'KVA':220},
       {'no':4, 'bus':'91', 'numphase':3, 'phaseconn':'.1.2.3', 'size':225, 'kV':4.16, 'KVA':225},
       {'no':5, 'bus':'108', 'numphase':3, 'phaseconn':'.1.2.3', 'size':250, 'kV':4.16, 'KVA':250}]
...
scid  = 0
### Scenario generation
NSc = 1000 # parameter indicating no.of scenarios for each
...
# Write list
with open(FolderName+ './PVAttacks_123.pkl', 'wb') as file:

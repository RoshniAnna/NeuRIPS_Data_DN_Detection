...
for charger_name in charger_data.dtype.names:
    ...
    data = {'Latitude':latitude, 
            ...
            'daily_charging_power':daily_charging_power*10,
...
# Charging Stations
StationsInfo  =[{'no': 1, 'bus': 'l3104136','numphase':3, 'phaseconn':'.1.2.3', 'kV':12.47, 'indx':0, 'kw':Chargers_Select[0]['PBase']*10, 'kwh':Chargers_Select[0]['PBase']*10.5*3600, 'stored':0, 'reserve':0},
                {'no': 2, 'bus': 'l2895449','numphase':3, 'phaseconn':'.1.2.3', 'kV':12.47, 'indx':1, 'kw':Chargers_Select[1]['PBase']*10, 'kwh':Chargers_Select[1]['PBase']*10.5*3600, 'stored':0, 'reserve':0},
                {'no': 3, 'bus': 'l3010560','numphase':3, 'phaseconn':'.1.2.3', 'kV':12.47, 'indx':2, 'kw':Chargers_Select[2]['PBase']*10, 'kwh':Chargers_Select[2]['PBase']*10.5*3600, 'stored':0, 'reserve':0},
                {'no': 4, 'bus': 'l2876797','numphase':3, 'phaseconn':'.1.2.3', 'kV':12.47, 'indx':0, 'kw':Chargers_Select[0]['PBase']*10, 'kwh':Chargers_Select[0]['PBase']*10.5*3600, 'stored':0, 'reserve':0},
                {'no': 5, 'bus': 'l2876814','numphase':3, 'phaseconn':'.1.2.3', 'kV':12.47, 'indx':1, 'kw':Chargers_Select[1]['PBase']*10, 'kwh':Chargers_Select[1]['PBase']*10.5*3600, 'stored':0, 'reserve':0},
                {'no': 6, 'bus': 'l3081380','numphase':3, 'phaseconn':'.1.2.3', 'kV':12.47, 'indx':2, 'kw':Chargers_Select[2]['PBase']*10, 'kwh':Chargers_Select[2]['PBase']*10.5*3600, 'stored':0, 'reserve':0},
                {'no': 7, 'bus': 'l2766718','numphase':3, 'phaseconn':'.1.2.3', 'kV':12.47, 'indx':1, 'kw':Chargers_Select[1]['PBase']*10, 'kwh':Chargers_Select[1]['PBase']*10.5*3600, 'stored':0, 'reserve':0}]
...
# Write list
with open(os.path.join(FolderName, 'EVCSAttacks_8500_1.pkl'), 'wb') as file:
